...
const TeapotAdminList = (): JSX.Element => {
    ...
    useEffect(() => {
        const init = async () => {
            const receivedTeapots = await TeapotsService.getTeapots(
                page,
                limit,
            );
                        ...
                        <thead>
                            <tr>
                                ...
                                <th
                                    ...
                                    scope="col"
                                    onClick={() =>
                                        navigate('/admin/add-teapot')
                                    }
                                >
                                    <div className="fw-light me-2">
                                        Add new teapot
                                    </div>
                                ...
                                <tr key={teapot.id}>
                                    ...
                                    <td className="align-middle">
                                        ...
                                        <div
                                            ...
                                            onClick={async () => {
                                                await TeapotsService.delTeapotById(
                                                    teapot.id!,
                                                );
                                                setTeapots((prev) =>
                                                    prev
