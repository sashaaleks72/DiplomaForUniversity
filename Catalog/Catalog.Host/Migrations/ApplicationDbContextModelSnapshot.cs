...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Catalog.Host.Data.Entities.CompanyEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Catalog.Host.Data.Entities.OrderProductEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Catalog.Host.Data.Entities.OrderStatusEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Catalog.Host.Data.Entities.RoleEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Catalog.Host.Data.Entities.TeapotEntity", b =>
                {
            ...
            modelBuilder.Entity("Catalog.Host.Data.Entities.OrderEntity", b =>
                {
                    b.HasOne("Catalog.Host.Data.Entities.OrderStatusEntity", "OrderStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("Catalog.Host.Data.Entities.OrderProductEntity", b =>
                {
                    ...
                    b.HasOne("Catalog.Host.Data.Entities.TeapotEntity", "Teapot")
                        .WithMany()
            ...
            modelBuilder.Entity("Catalog.Host.Data.Entities.TeapotEntity", b =>
                {
                    b.HasOne("Catalog.Host.Data.Entities.CompanyEntity", "Company")
                        .WithMany()
            ...
            modelBuilder.Entity("Catalog.Host.Data.Entities.UserEntity", b =>
                {
                    b.HasOne("Catalog.Host.Data.Entities.RoleEntity", "Role")
                        .WithMany()
